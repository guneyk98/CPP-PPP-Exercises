...
export Roman_int operator+(const Roman_int& lhs, const Roman_int& rhs);
export Roman_int operator-(const Roman_int& lhs, const Roman_int& rhs);
export Roman_int operator*(const Roman_int& lhs, const Roman_int& rhs);
export Roman_int operator/(const Roman_int& lhs, const Roman_int& rhs);
export std::istream& operator>>(std::istream& is, Roman_int& r);
export std::ostream& operator<<(std::ostream& os, const Roman_int& r);
...
{
	return Roman_int{lhs.as_int() + rhs.as_int()};
}
